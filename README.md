...
If it is a simple/trivial/non-controversial change, then one of the Liberalcoin
...
completely stable. [Tags](https://github.com/liberalcoin-project/liberalcoin/tags) are created
regularly to indicate new official, stable release versions of Liberalcoin.
